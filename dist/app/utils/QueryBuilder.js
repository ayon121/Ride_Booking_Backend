...
class QueryBuilder {
    constructor(modelQuery, query) {
        this.filterQuery = {}; // ✅ Store for meta count
    ...
    filter() {
        ...
        this.filterQuery = filter; // ✅ Fix type
    ...
    search(searchableField) {
        ...
        if (searchTerm) {
            ...
            this.filterQuery = Object.assign(Object.assign({}, this.filterQuery), searchConditions);
    ...
    getMeta() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const totalDocuments = yield this.modelQuery.model.countDocuments(this.filterQuery);
